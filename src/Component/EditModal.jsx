  ...
  return (
   <div className={`fixed top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.6)] flex justify-center items-center z-50 transition-opacity duration-500 ${props.modalDesign ?"opacity-100":'opacity-0'} `}>
      ...
      <form onSubmit={props.formSub} className='mt-[30px] flex flex-col items-center'>
        <input className='border mt-[15px] px-[10px] py-[10px] w-[400px] rounded-2xl' value={props.nameValue} onChange={props.nameOnCh} type='text'/>
        <input className='border mt-[15px] px-[10px] py-[10px] w-[400px] rounded-2xl' value={props.subValue} onChange={props.subOnCh}  type='text'/>
          <textarea className='border-1 mt-[15px] px-[10px] py-[10px] w-[400px] rounded-2xl' value={props.desValue} onChange={props.desOnCh}/>
