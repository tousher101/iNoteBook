...
function SearchDisplay(props) {
  return (
     <div key={props.searchKey} onClick={props.onClick}className='flex-1 min-w-[300px] border p-4 rounded-md shadow-md mx-[20px] bg-[#DECBA4] hover:scale-105 duration-1000'>
